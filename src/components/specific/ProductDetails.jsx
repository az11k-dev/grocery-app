...
export default function ProductDetails() {
    ...
    return (
        <div className={"p-5"}>
            <div>
                <div className={"flex items-start justify-start pt-5 mb-20"}>
                    <img className={"w-[23px] h-[16px]"} src={backIcon} alt="back"/>
                </div>
            ...
            <div>
                ...
                <p className={"text-xs font-normal text-ftxt"}>
                    {productData.description}
                </p>
                <div className={"flex items-center justify-between bg-fbg rounded-[5px] p-4"}>
                    <p>
                        Quantity
                    </p>
